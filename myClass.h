...
// Mon Oct 14 21:53:10 2019 by ROOT version 5.34/34
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/lustre/nyx/hades/user/nrathod/PLUTO/TEST/Events_pi0/pi0_0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/lustre/nyx/hades/user/nrathod/PLUTO/TEST/Events_pi0/pi0_0.root");
      }
      ...
      chain->Add("/lustre/nyx/hades/user/nrathod/PLUTO/TEST/Events_pi0/pi0_0.root/data");
      tree = chain;
#endif // SINGLE_TREE
